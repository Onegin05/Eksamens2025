...
if ($user_id === $_SESSION['user_id']) {
    $_SESSION['error'] = 'Nevar modificēt savu admin statusu.';
    header('Location: ../index.php');
    exit;
}
...
if ($stmt->execute()) {
    $_SESSION['success'] = 'Lietotāja admin statuss veiksmīgi atjaunināts.';
} else {
    $_SESSION['error'] = 'Kļūda atjauninot lietotāja admin statusu.';
}
